...
class {camelCaseNodeName}Config(object):
    """
    ...
    def __str__(self):
        msg = "Instance of {camelCaseNodeName}Config class: {"
        {forallparameter}
...
class {camelCaseNodeName}Data(object):
    """
    ...
    def __init__(self):
        """
        Definition of the {camelCaseNodeName}Data attributes
        """
        {ifsubscriber}
        # input data
        {endifsubscriber}
    ...
    def __str__(self):
        msg = "Instance of {camelCaseNodeName}Data class: \n {"
        {forallsubscriber}
...
class {camelCaseNodeName}Passthrough(object):
    """
...
class {camelCaseNodeName}Implementation(object):
    """
    ...
    def __init__(self):
        ...
        """
        self.passthrough = {camelCaseNodeName}Passthrough()
